...
if __name__ == '__main__':
    ...
    write_version_to_file(version, '../OpenPCDet_test/pcdet/version.py')

    setup(
        name='pcdet',
        version=version,
        description='origin_OpenPCDet is a general codebase for 3D object detection from point cloud',
        install_requires=[
            'numpy',
            'llvmlite',
            'numba',
