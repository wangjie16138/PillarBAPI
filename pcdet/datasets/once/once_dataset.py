...
class ONCEDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        self.split = dataset_cfg.DATA_SPLIT['train'] if training else dataset_cfg.DATA_SPLIT['study_file']
        assert self.split in ['train', 'val', 'study_file', 'raw_small', 'raw_medium', 'raw_large']
...
def create_once_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    ...
    splits = ['train', 'val', 'study_file', 'raw_small', 'raw_medium', 'raw_large']
    ignore = ['study_file']
